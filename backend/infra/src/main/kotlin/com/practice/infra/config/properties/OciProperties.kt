package com.practice.infra.config.properties
...
class OciProperties {
    ...
    companion object {
        val WRITE_EXPIRE_DURATION: Duration = Duration.ofMinutes(5)
        val READ_EXPIRE_DURATION: Duration = Duration.ofDays(1)
